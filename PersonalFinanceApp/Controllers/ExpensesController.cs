...
namespace PersonalFinanceApp.Controllers
{
    public class ExpensesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Value,Category")] Expense expense)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Value,Category")] Expense expense)
        {
            if (id != expense.Id)
            {
                return NotFound();
